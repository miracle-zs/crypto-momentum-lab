...
class ScheduledRiskWindowConfig:
    ...
    times.  ``reopen_at`` is set to 08:02 so the account gets a short quiet
    period after the 08:00 event before new entries are allowed again.
    """
